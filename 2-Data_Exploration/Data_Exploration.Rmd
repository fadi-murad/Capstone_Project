...
#### 2.23 country_father
While europe has slightly better pecentage for income level 1, central and south america has no people with income level 1
...
#### 2.24 country_mother
As same as the country father variable, eourpe has slightly better pecentage for income level 1, central and south america has no people with income level 1
```{r}
...
Now after we have fairly understanding for each variable, we are ready to start the next step **data cleaning and manipulation**.
